...
class YoloSignPoseNode:
    def __init__(self):
        ...
        # Default real-world sign dimensions (cm)
        self.sign_default_width  = 6.0
        self.sign_default_height = 6.0

        # Prefix → (width_cm, height_cm, shape)
        self.sign_specs = {
        ...
        # —————————————— LOAD YOLOv5 ——————————————
        # Ensure local yolov5 repo is first on PYTHONPATH
        ...
        # Log the actual class names so you can verify sign_specs keys
        ...
        # Assign a unique color per class (BGR), reproducibly
    ...
    def image_cb(self, msg: Image):
        ...
        # — Convert to RGB for YOLO & run inference —
